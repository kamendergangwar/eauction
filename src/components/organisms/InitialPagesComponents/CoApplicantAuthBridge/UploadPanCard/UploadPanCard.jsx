  ...
  return (
    <KycTemplate isCoApplicant={true}>
      ...
      <div className={classes.kycCompMainBox}>
        <Hidden smDown>
          <KycTitleDescriBox
            title={t("uploadPanCardForm.title1")}
            description={t("uploadPanCardForm.description1")}
          />
        </Hidden>
        <Hidden mdUp>
          ...
          {({ submitForm, setFieldValue }) => (
            <Form noValidate autoComplete="off" className={classes.kycFormContainer}>
                ...
                {!isUploaded && !isFileFetching && (
                  ...
                  >
                    ...
                    <Box className={classes.dragNdDropText}>
                      {t("uploadPanCardForm.formControl.dragNdDropText")}
                      <input
                      ...
                      <label htmlFor="fileData">
                        <Button
                          ...
                          size="small"
                        >
                          {t("uploadPanCardForm.formControl.browseBtnText")}
                        </Button>
                      </label>
                    </Box>
                    ...
                    <Box margint={2}>
                      <Typography style={{ fontSize: 12 }}>
                        {t("uploadPanCardForm.formControl.fileLimit0")}
                        <strong>  {t("uploadPanCardForm.formControl.fileLimit1")} </strong>
                        {t("uploadPanCardForm.formControl.fileLimit2")}
                      </Typography>
                    </Box>
                  </Box>
                )}
                {isUploaded && !isFileFetching && (
                  <Box>
                    <Typography
                      ...
                      variant="subtitle1"
                    >
                      {t("uploadPanCardForm.formControl.kycCaptionTxt1")}
                    </Typography>
                    {isImage ? <Box className={classes.panCardPreviewCard}>
                      ...
                      <Typography className={classes.kycCaption}>
                        {t("uploadPanCardForm.formControl.success")}
                      </Typography>
                    </Box>}
                    <Box textAlign="left" marginTop={2}>
                      <Typography
                        ...
                        variant="subtitle1"
                      >
                        {t("uploadPanCardForm.formControl.kycCaptionTxt2")}
                      </Typography>
                    </Box>
                      ...
                      <Grid container spacing={1} alignItems="center">
                        ...
                        <Grid item xs="auto">
                          <Button
                            ...
                            onClick={onReUpload}
                          >
                            {t("uploadPanCardForm.formControl.buttonText2")}
                          </Button>
                        </Grid>
                      </Grid>
                    </Box>
              ...
              {/* {localStorage.getItem("skipFlow") == "true" && <Button
                ...
                >
                  {t("uploadPanCardForm.formControl.buttonText3")}
                </Button>
              </Box>
            </Form>
          )}
