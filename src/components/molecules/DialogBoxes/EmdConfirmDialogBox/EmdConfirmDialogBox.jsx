...
const EmdConfirmDialogBox = (props) => {
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description0" style={{color:"#000000",fontSize:"15px"}}>
            {t("emdconfirmDialog.description1")}<strong style={{color:'red'}}>{description}</strong>{t("emdconfirmDialog.description2")}
          </DialogContentText>
          {question && (
...
export default EmdConfirmDialogBox;
